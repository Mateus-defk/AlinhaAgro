...
Produtores rurais de médio porte (5–50 ha) não têm controle financeiro estruturado. As consequências são:
...
O AgroGestão resolve isso com uma interface pensada para uso no celular, mesmo em áreas rurais com conectividade limitada.
...
**Horizonte 1 — 2025:** Fruticultura de manga no Vale do São Francisco. Produto validado com produtores de Petrolina e Juazeiro.

**Horizonte 2 — 2026:** Expansão para uva, goiaba, acerola e outras frutíferas irrigadas. Módulo de crédito rural e relatórios para bancos.
...
| Perfil | Descrição |
|---|---|
| **Produtor primário** | 5–30 ha, fruticultura irrigada, acesso via celular |
...
| Plano | Preço | Foco |
|---|---|---|
| Mensal | R$ 159,90/mês | Entrada, produtor pequeno |
| Trimestral | R$ 369,90/trim. | Produtor médio, maior controle |
| Anual Premium | R$ 1.500,00/ano | Produtor profissional, todas as funcionalidades |
